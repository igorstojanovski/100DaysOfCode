...
public class TestRuns extends VerticalLayout {
    ...
    @Autowired
    public TestRuns(@Qualifier("RunsProvider") PageableDataProvider<Run, Void> pageableDataProvider) {
        ...
        grid.addColumn(run -> run.getResults().size()).setHeader("CcTest Count");
        grid.addColumn(
